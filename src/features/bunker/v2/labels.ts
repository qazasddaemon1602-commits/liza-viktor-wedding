...
const ARCHIVE_LABELS: Record<string, { title: string; hint: string }> = {
  ...
  'ARCHIVE-BK17': { title: 'Папка BK-17', hint: 'Материал из чёрного ящика. Сохраните обозначение — оно понадобится дальше.' },
  'UNKNOWN-BK17': { title: 'Досье BK-17', hint: 'Досье неизвестного пассажира, связанное с Бункером.' },
  ...
  'ACCESS-4719': { title: 'Код доступа 4719', hint: 'Код из общего протокола. Он понадобится в финальном терминале.' },
  'ACCESS-CARD': { title: 'Карта доступа', hint: 'Служебная карта из архива вагона.' },
  'SEALED-DOCUMENT': { title: 'Запечатанный документ', hint: 'Архивный документ, найденный вагоном.' },
};
