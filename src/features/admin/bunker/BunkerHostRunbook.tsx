...
const INTERMISSIONS: Record<IntermissionKey, RunbookContent> = {
  ...
  BUNKER_OPEN: {
    ...
    host: {
      brief: 'Передайте финальный экран Лизе: одна реплика ведущего, затем тишина до полного раскрытия и только после него — свет и аплодисменты.',
      say: [
        'Последний сигнал принят. Пожалуйста, смотрите на экран.',
      ],
      improvise: [
        'До реплики приглушите свет в зале.',
        'После реплики замолчите: не говорите поверх звука двери и голоса Лизы.',
      ],
      hints: [
        'Дождитесь двери, аудио раскрытия и полного текста на экране: «Сигнал принят. Поезд Виктора прибыл. Я ждала вас. — Лиза».',
        'Не запускайте FINISHED и не включайте тёплый свет, пока раскрытие не завершится.',
      ],
      doNotRevealUntil: [
        'Не комментируйте раскрытие и не перебивайте экран до конца реплики.',
        'Не показывайте технические ответы и персональные скрытые карточки.',
      ],
      afterCompletion: 'После полного раскрытия скажите: «Источник BK-17 раскрыт. Лиза ждала именно этот состав. Маршрут Виктора завершён.» Затем включите тёплый свет и ведите аплодисменты; FINISHED и эпилог остаются отдельным шагом.',
    },
  },
  FINISHED: {
    title: 'Эпилог',
