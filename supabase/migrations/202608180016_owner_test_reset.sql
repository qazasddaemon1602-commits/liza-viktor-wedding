...
begin
  ...
  -- Live quiz/tournament answers. Couple preanswers are intentionally preserved.
  ...
  -- A reset should also clear the rehearsal action history. Keep only the reset marker.
