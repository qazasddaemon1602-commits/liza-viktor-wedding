-- Forward-only security hardening for the persistent guest dashboard.
-- The dashboard never needs raw archive payloads; story/final RPCs own staged disclosure.
